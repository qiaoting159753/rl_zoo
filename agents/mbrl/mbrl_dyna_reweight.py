...
from envs.openai_pendulum import PendulumEnv
...
class DynaSAC_Reweight:
    ...
    def query(self, states, us):
        def angle_normalize(h):
    ...
    def sampling(self, pred_means, pred_vars):
        ...
        # uncert = total_stds
        uncert = 1.5 - total_stds
        return uncert.detach()