...
def load_pnn():
    algorithm = "ensemble"
    finger_1 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/5_1.csv")
    finger_2 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/5_2.csv")
    finger_3 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/5_3.csv")
    reacher_1 = pd.read_csv(location + algorithm + "/reacher_hard_param/5_1.csv")
    reacher_2 = pd.read_csv(location + algorithm + "/reacher_hard_param/5_2.csv")
    reacher_3 = pd.read_csv(location + algorithm + "/reacher_hard_param/5_3.csv")
    fish_1 = pd.read_csv(location + algorithm + "/fish_swim_param/5_1.csv")
    fish_2 = pd.read_csv(location + algorithm + "/fish_swim_param/5_2.csv")
    fish_3 = pd.read_csv(location + algorithm + "/fish_swim_param/5_3.csv")
    data_list_pnn = [finger_1, reacher_1, fish_1, finger_1, reacher_1, fish_1, fish_1,
                     finger_2, reacher_2, fish_2, finger_2, reacher_2, fish_2, fish_2,
                     finger_3, reacher_3, fish_3, finger_3, reacher_3, fish_3, fish_3]
    return data_list_pnn

def load_1():
    algorithm = "ensemble"
    finger_1 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/15_1.csv")
    finger_2 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/15_2.csv")
    finger_3 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/15_3.csv")
    reacher_1 = pd.read_csv(location + algorithm + "/reacher_hard_param/15_1.csv")
    reacher_2 = pd.read_csv(location + algorithm + "/reacher_hard_param/15_2.csv")
    reacher_3 = pd.read_csv(location + algorithm + "/reacher_hard_param/15_3.csv")
    fish_1 = pd.read_csv(location + algorithm + "/fish_swim_param/5_1.csv")
    fish_2 = pd.read_csv(location + algorithm + "/fish_swim_param/5_2.csv")
    fish_3 = pd.read_csv(location + algorithm + "/fish_swim_param/5_3.csv")
    data_list_pnn = [finger_1, reacher_1, fish_1, finger_1, reacher_1, fish_1, fish_1,
...
def load_2():
    algorithm = "ensemble"
    finger_1 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/25_1.csv")
    finger_2 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/25_2.csv")
    finger_3 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/25_3.csv")
    reacher_1 = pd.read_csv(location + algorithm + "/reacher_hard_param/25_1.csv")
    reacher_2 = pd.read_csv(location + algorithm + "/reacher_hard_param/25_2.csv")
    reacher_3 = pd.read_csv(location + algorithm + "/reacher_hard_param/25_3.csv")
    fish_1 = pd.read_csv(location + algorithm + "/fish_swim_param/25_1.csv")
    fish_2 = pd.read_csv(location + algorithm + "/fish_swim_param/25_2.csv")
    fish_3 = pd.read_csv(location + algorithm + "/fish_swim_param/25_3.csv")
    data_list_pnn = [finger_1, reacher_1, fish_1, finger_1, reacher_1, fish_1, fish_1,
                     finger_2, reacher_2, fish_2, finger_2, reacher_2, fish_2, fish_2,
                     finger_3, reacher_3, fish_3, finger_3, reacher_3, fish_3, fish_3]
    return data_list_pnn
...
def load_3():
    algorithm = "ensemble"
    finger_1 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/100_1.csv")
    finger_2 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/100_2.csv")
    finger_3 = pd.read_csv(location + algorithm + "/finger_turn_hard_param/100_3.csv")
    reacher_1 = pd.read_csv(location + algorithm + "/reacher_hard_param/100_1.csv")
    reacher_2 = pd.read_csv(location + algorithm + "/reacher_hard_param/100_2.csv")
    reacher_3 = pd.read_csv(location + algorithm + "/reacher_hard_param/100_3.csv")
    fish_1 = pd.read_csv(location + algorithm + "/fish_swim_param/100_1.csv")
    fish_2 = pd.read_csv(location + algorithm + "/fish_swim_param/100_2.csv")
    fish_3 = pd.read_csv(location + algorithm + "/fish_swim_param/100_3.csv")
    data_list_pnn = [finger_1, reacher_1, fish_1, finger_1, reacher_1, fish_1, fish_1,
                     finger_2, reacher_2, fish_2, finger_2, reacher_2, fish_2, fish_2,
                     finger_3, reacher_3, fish_3, finger_3, reacher_3, fish_3, fish_3]
    return data_list_pnn
