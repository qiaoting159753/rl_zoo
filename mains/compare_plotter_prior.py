...
def load_1():
    algorithm = "prior_network"
    finger_1 = pd.read_csv(location + algorithm + "/finger_turn_hard/0.5_1.csv")
    finger_2 = pd.read_csv(location + algorithm + "/finger_turn_hard/0.5_2.csv")
    finger_3 = pd.read_csv(location + algorithm + "/finger_turn_hard/0.5_3.csv")
    reacher_1 = pd.read_csv(location + algorithm + "/reacher_hard/0.5_1.csv")
    reacher_2 = pd.read_csv(location + algorithm + "/reacher_hard/0.5_2.csv")
    reacher_3 = pd.read_csv(location + algorithm + "/reacher_hard/0.5_3.csv")
    fish_1 = pd.read_csv(location + algorithm + "/fish_swim/0.5_1.csv")
    fish_2 = pd.read_csv(location + algorithm + "/fish_swim/0.5_2.csv")
    fish_3 = pd.read_csv(location + algorithm + "/fish_swim/0.5_3.csv")
    hcheetah_1 = pd.read_csv(location + algorithm + "/HalfCheetah-v5_/0.5_1.csv")
    hcheetah_2 = pd.read_csv(location + algorithm + "/HalfCheetah-v5_/0.5_2.csv")
    hcheetah_3 = pd.read_csv(location + algorithm + "/HalfCheetah-v5_/0.5_3.csv")
    hopper_1 = pd.read_csv(location + algorithm + "/Hopper-v5_/0.5_1.csv")
    hopper_2 = pd.read_csv(location + algorithm + "/Hopper-v5_/0.5_2.csv")
    hopper_3 = pd.read_csv(location + algorithm + "/Hopper-v5_/0.5_3.csv")
    swimmer_1 = pd.read_csv(location + algorithm + "/Swimmer-v5_/0.5_1.csv")
    swimmer_2 = pd.read_csv(location + algorithm + "/Swimmer-v5_/0.5_2.csv")
    swimmer_3 = pd.read_csv(location + algorithm + "/Swimmer-v5_/0.5_3.csv")
    walker_1 = pd.read_csv(location + algorithm + "/Walker2d-v5_/0.5_1.csv")
    walker_2 = pd.read_csv(location + algorithm + "/Walker2d-v5_/0.5_2.csv")
    walker_3 = pd.read_csv(location + algorithm + "/Walker2d-v5_/0.5_3.csv")
    data_list_pnn = [finger_1, reacher_1, fish_1, hcheetah_1, hopper_1, swimmer_1, walker_1,
                     finger_2, reacher_2, fish_2, hcheetah_2, hopper_2, swimmer_2, walker_2,
                     finger_3, reacher_3, fish_3, hcheetah_3, hopper_3, swimmer_3, walker_3]
    return data_list_pnn
