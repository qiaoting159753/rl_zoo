...
def load_prior():
    algorithm = "prior/Prior_World_Model_"
...
def load_ensemble():
    algorithm = "ensemble/big_network/Ensemble_Dyna_Big_"
...
def load_bbb():
    algorithm = "bayesian/Bayesian_VI_"
...
for abc in range(7):
    for cba in range(3):
        ...
        if attr == 'kendall_corr_l1':
            plt.ylabel("Kendall-Tau", fontsize=label_fontsize)
        elif attr == 'spearman_corr_l1':
            plt.ylabel("Spearman", fontsize=label_fontsize)
        elif attr == 'xi_corr_l1':
            plt.ylabel("Xi", fontsize=label_fontsize)
