...
def load_pnn():
    algorithm = "ensemble/overfit/Trained_Rewards_Ensemble_Dyna_Big_"

    acrobot_1 = pd.read_csv(location + algorithm + "acrobot_swingup/30_0_0_15.csv.csv")
    ball_1 = pd.read_csv(location + algorithm + "ball_in_cup_catch/30_0_0_15.csv.csv")
    cartpole_1 = pd.read_csv(location + algorithm + "cartpole_swingup/30_0_0_15.csv.csv")

    finger_1 = pd.read_csv(location + algorithm + "finger_turn_hard/30_6_0_0_15.csv.csv")
    reacher_1 = pd.read_csv(location + algorithm + "reacher_hard/30_6_0_0_15.csv.csv")
    fish_1 = pd.read_csv(location + algorithm + "fish_swim/30_6_0_0_15.csv.csv")
    hcheetah_1 = pd.read_csv(location + algorithm + "HalfCheetah-v5_/30_6_0_0_15.csv.csv")
    hopper_1 = pd.read_csv(location + algorithm + "Hopper-v5_/30_6_0_0_15.csv.csv")
    swimmer_1 = pd.read_csv(location + algorithm + "Swimmer-v5_/30_6_0_0_15.csv.csv")
    walker_1 = pd.read_csv(location + algorithm + "Walker2d-v5_/30_6_0_0_15.csv.csv")

    acrobot_2 = pd.read_csv(location + algorithm + "acrobot_swingup/30_0_0_25.csv.csv")
    ball_2 = pd.read_csv(location + algorithm + "ball_in_cup_catch/30_0_0_25.csv.csv")
    cartpole_2 = pd.read_csv(location + algorithm + "cartpole_swingup/30_0_0_25.csv.csv")

    finger_2 = pd.read_csv(location + algorithm + "finger_turn_hard/30_6_0_0_25.csv.csv")
    reacher_2 = pd.read_csv(location + algorithm + "reacher_hard/30_6_0_0_25.csv.csv")
    fish_2 = pd.read_csv(location + algorithm + "fish_swim/30_6_0_0_25.csv.csv")
    hcheetah_2 = pd.read_csv(location + algorithm + "HalfCheetah-v5_/30_6_0_0_25.csv.csv")
    hopper_2 = pd.read_csv(location + algorithm + "Hopper-v5_/30_6_0_0_25.csv.csv")
    swimmer_2 = pd.read_csv(location + algorithm + "Swimmer-v5_/30_6_0_0_25.csv.csv")
    walker_2 = pd.read_csv(location + algorithm + "Walker2d-v5_/30_6_0_0_25.csv.csv")

    acrobot_3 = pd.read_csv(location + algorithm + "acrobot_swingup/30_0_0_35.csv.csv")
    ball_3 = pd.read_csv(location + algorithm + "ball_in_cup_catch/30_0_0_35.csv.csv")
    cartpole_3 = pd.read_csv(location + algorithm + "cartpole_swingup/30_0_0_35.csv.csv")

    finger_3 = pd.read_csv(location + algorithm + "finger_turn_hard/30_6_0_0_35.csv.csv")
    reacher_3 = pd.read_csv(location + algorithm + "reacher_hard/30_6_0_0_35.csv.csv")
    fish_3 = pd.read_csv(location + algorithm + "fish_swim/30_6_0_0_35.csv.csv")
    hcheetah_3 = pd.read_csv(location + algorithm + "HalfCheetah-v5_/30_6_0_0_35.csv.csv")
    hopper_3 = pd.read_csv(location + algorithm + "Hopper-v5_/30_6_0_0_35.csv.csv")
    swimmer_3 = pd.read_csv(location + algorithm + "Swimmer-v5_/30_6_0_0_35.csv.csv")
    walker_3 = pd.read_csv(location + algorithm + "Walker2d-v5_/30_6_0_0_35.csv.csv")
    ...
    # data_list_pnn = [acrobot_1, ball_1, cartpole_1, hcheetah_1, hopper_1, swimmer_1, walker_1,
    #                  acrobot_2, ball_2, cartpole_2, hcheetah_2, hopper_2, swimmer_2, walker_2,
    #                  acrobot_3, ball_3, cartpole_3, hcheetah_3, hopper_3, swimmer_3, walker_3]
