...
def load_pnn():
    ...
    algorithm = "non-overfit/big_network/"
    ...
    hcheetah_1 = pd.read_csv(location + algorithm + "HalfCheetah-v5/30_9_0_15.csv.csv")
    hcheetah_2 = pd.read_csv(location + algorithm + "HalfCheetah-v5/30_9_0_25.csv.csv")
    hcheetah_3 = pd.read_csv(location + algorithm + "HalfCheetah-v5/30_9_0_35.csv.csv")
    hopper_1 = pd.read_csv(location + algorithm + "Hopper-v5/30_9_0_15.csv.csv")
    hopper_2 = pd.read_csv(location + algorithm + "Hopper-v5/30_9_0_25.csv.csv")
    hopper_3 = pd.read_csv(location + algorithm + "Hopper-v5/30_9_0_35.csv.csv")
    swimmer_1 = pd.read_csv(location + algorithm + "Swimmer-v5/30_9_0_15.csv.csv")
    swimmer_2 = pd.read_csv(location + algorithm + "Swimmer-v5/30_9_0_25.csv.csv")
    swimmer_3 = pd.read_csv(location + algorithm + "Swimmer-v5/30_9_0_35.csv.csv")
    walker_1 = pd.read_csv(location + algorithm + "Walker2d-v5/30_9_0_15.csv.csv")
    walker_2 = pd.read_csv(location + algorithm + "Walker2d-v5/30_9_0_25.csv.csv")
    walker_3 = pd.read_csv(location + algorithm + "Walker2d-v5/30_9_0_35.csv.csv")
...
# 25
def load_1():
    location = "/Users/tonyq/Desktop/CH1_Data/ensemble/overfit"
    algorithm = "/"
    finger_1 = pd.read_csv(location + algorithm + "finger_turn_hard/30_9_0_15.csv.csv")
    finger_2 = pd.read_csv(location + algorithm + "finger_turn_hard/30_9_0_25.csv.csv")
    finger_3 = pd.read_csv(location + algorithm + "finger_turn_hard/30_9_0_35.csv.csv")
